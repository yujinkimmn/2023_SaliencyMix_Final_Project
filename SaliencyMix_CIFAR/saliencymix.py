...
# For example, to train Resnet18 with saliency mix and data augmentation, use
...
# --data_augmentation \
# --learning_rate 0.1
#  > /home/pbl9/group10/results/logs/cifar10_resnet18_salinecymix.log 2>&1 &
